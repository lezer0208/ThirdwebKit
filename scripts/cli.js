...
const contractABI = require("../artifacts/contracts/Thirdwebkit.sol/Thirdwebkit.json").abi;

program
    .name("thirdwebkit-cli")
    .description("CLI tool for Thirdwebkit smart contract")
    .version("1.0.0");
